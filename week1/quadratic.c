...
roots findroots(float a,float b,float c); int main(){
	roots qd;
	float a,b,c;
	printf("enter the coefficients of x^2, x and the constants:");
	scanf("%f%f%f",&a,&b,&c);
	qd = findroots(a,b,c);
	printf("the roots of the quadratic equation are: %f + i %f and %f 
-i%f",qd.r1.real,qd.r1.imaginary,qd.r2.real,qd.r2.imaginary);
	return 0;
	}
